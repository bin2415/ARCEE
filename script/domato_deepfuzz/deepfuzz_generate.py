...
import sys
sys.path.append('/home/ubuntu/fuzzing_mnt2/tensorflow/')
...
if __name__ == "__main__":
    for j in range(10):
        ...
        '''
    #deepfuzz_tags= ['a','abbr','address','article','aside','audio','b','bdo','blockquote','br','button','canvas','cite','code','datalist','del','details','dfn','dialog','div','dl','em','embed','figure','footer','form','h1','h2','h3','h4','h5','h6','hr','i','iframe','img','input','ins','kbd','main','map','mark','meter','nav','object','ol','output','p','pre','progress','q','ruby','s','samp','section','select','small','span','strong','style''sub','sup','table','textarea','time','track','u','ul','var','video','wbr']
