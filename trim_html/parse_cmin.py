...
TAGS_CNT = dict()
RATE_TAKEN = 0.5
MAX_TIME_OUT = 400 # set timeout as 800ms
BLACK_TIME_OUT = set()
...
def test_valid_trim(trimed_str):
    ...
    if not run_showmap_with_pdf(pdf_input, tmp_output):
...
def run_showmap_with_pdf(pdf_input, output):
    '''
